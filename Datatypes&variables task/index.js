...
var joke = "Question: Why couldn't the shoes go out and play?\nAnswer:   They were all \"tied\" up!";
console.log(joke);
...
let awesomeMessage = `Hi, my name is  ${firstName}. I love ${interest}. In my spare time, Ilike to ${hobby}.`;
